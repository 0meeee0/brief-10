...
logout</span>Logout</a>
    ...
    <tr>
        ...
        <td><?= $schedule->getBusnumber() ?></td>
        <td><?= $schedule->getStartcity() ?></td>
        td><?= $schedule->getEndcity() ?></td>
        <td><a href="index.php?action=editschedule&immat=<?= $category->getScheduleById() ?>" class="btn btn-warning">Update</a></td>
        <td><a href="index.php?action=deleteschedule&immat=<?= $category->getScheduleById() ?>" class="btn btn-danger">Delete</a></td>
    </tr>
<?php endforeach; ?>
      </tbody>
    </table>
