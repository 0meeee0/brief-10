...
logout</span>Logout</a>
    ...
    <tr>
        <td><?= $road->getDistance() ?></td>
        <td><?= $road->getDuration() ?></td>
        <td><?= $road->getStartcity() ?></td>
        <td><?= $road->getEndcity() ?></td>
        <td><a href="index.php?action=editroad&startcity&endcity=<?= $category->getRoadByCity() ?>" class="btn btn-warning">Update</a></td>
        <td><a href="index.php?action=delete&immat=<?= $category->getRoadByCity() ?>" class="btn btn-danger">Delete</a></td>
    </tr>
<?php endforeach; ?>
      </tbody>
    </table>
